...
function initializeContactForm() {
  ...
  contactForm.addEventListener('submit', function(e) {
      ...
      if (!messageInput.value.trim() || messageInput.value.trim().length < 10) {
          showError(messageInput, 'messageError', 'Please enter your message (at least 1 characters)');
          isValid = false;
      }
  ...
  function submitForm(form) {
      ...
      //whatsapp
        const url = "https://api.whatsapp.com/send?phone=6282128556227&text=Hallo%20admin.%0ASaya%20*"+ name +"*%0Aemail%20saya%20*"+ email +"*%0ANomor%20phone%20*"+ phone +"*%0AKebutuhan%20*"+ service +"*%0A%0A*"+ message +"*"
